  ...
  return (
    <>
      <main style={{ flex: 1, overflowY: "auto", fontFamily: "'Manrope', sans-serif" }}>
        ...
        {/* ── NAV BAR IN-PAGE ──────────────────────────────────── */}
        <nav style={{ background: "linear-gradient(135deg,#052e35 0%,#043941 100%)", borderBottom: "1px solid rgba(2,212,126,0.15)", padding: "0 clamp(1.5rem,5vw,4rem)", position: "sticky", top: 0, zIndex: 40 }}>
          <div style={{ display: "flex", gap: "0.25rem", alignItems: "center" }}>
            ...
            {[
              ...
              <button key={item.target}
                ...
                style={{ background: "transparent", border: "none", color: "rgba(255,255,255,0.65)", fontSize: "0.82rem", fontWeight: 600, padding: "1rem 1.5rem", cursor: "pointer", borderBottom: "2px solid transparent", transition: "all 0.2s", letterSpacing: "0.01em", fontFamily: "'Manrope', sans-serif" }}
